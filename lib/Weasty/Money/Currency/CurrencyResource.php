...
class CurrencyResource
{
    ...
    protected function buildCurrency($alphabeticCode, array $data = array())
    {
        ...
        if (!$alphabeticCode) {
            throw new \Exception("Currency alphabetic code is empty[$alphabeticCode]");
        }
    ...
    public function getCurrencyParameter($alphabeticCode, $parameterName)
    {
        ...
        $currency = $this->getCurrency($alphabeticCode ?: $this->getDefaultCurrency());
    ...
    /**
     * @return \Weasty\Money\Currency\CurrencyInterface[]
     */

<?php
namespace Weasty\Money\Loader\BYN;
...
/**
 * Class BYNLoader
 * @package Weasty\Money\Loader\BYN
 */
class BYNLoader implements LoaderInterface
{

    const DESTINATION_CURRENCY_CODE = 'BYN';
    ...
    public function load( \DateTime $dateTime = null ) {
                ...
                function ( $record ) {
                    ...
                    switch ( $code ) {
                        case 'XDR':
                            ...
                            break;
                        default:
                            $rate   = filter_var( $record['Rate'] / $record['Scale'], FILTER_VALIDATE_FLOAT );
        ...
        $currencyRecords[] = new Record( 'BYR', self::DESTINATION_CURRENCY_CODE, 0.0001 );
